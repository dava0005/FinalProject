...
public class MainRoute extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pref_name.contains("questionCount")) {
            seekbar.setProgress(pref_name.getInt("questionCount", -1));
        }
        if (pref_name.contains("QuestionType")) {
            QuestionType = pref_name.getInt("QuestionType", -1);
        }
        ...
        homeStartButton.setOnClickListener(click ->
        {
            ...
            goToProfile.putExtra("questionCount", progressChangedValue);
            goToProfile.putExtra("QuestionType", QuestionType);
    ...
    protected void onPause() {
        ...
        if (multipleRadio.isChecked()) QuestionType = 0;
        else QuestionType = 1;
        ...
        myEdit.putInt("questionCount", progressChangedValue);
        myEdit.putInt("QuestionType", QuestionType);
